...
function getMockAgents(): Agent[] {
  return [
    ...
    },
    {
      ...
      description: "Analyzes gender dynamics and power structures in data",
      model: "gpt-4",
      temperature: 0.6,
      max_tokens: 300,
      prompt: "Analyze the following data through a feminist lens...",
      is_active: true,
      is_public: true,
      is_safe_mode: true,
      is_streaming: false,
    ...
    },
    {
      ...
      status: "analyzing",
      insights: [],
      description: "Identifies biases in data and research methodologies",
      model: "gpt-3.5-turbo",
      temperature: 0.5,
      max_tokens: 250,
      prompt: "Analyze the following research for potential biases...",
      is_active: true,
      is_public: true,
      is_safe_mode: true,
      is_streaming: false,
    ...
    },
    {
      ...
      status: "idle",
      insights: [],
      description: "Triangulates findings across different research methods",
      model: "gpt-3.5-turbo",
      temperature: 0.6,
      max_tokens: 200,
      prompt: "Compare and triangulate the following research findings...",
      is_active: true,
      is_public: true,
      is_safe_mode: true,
      is_streaming: false,
